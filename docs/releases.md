...
| `v1.1.0` | 2026-08-24 | 独立 UI 实验版：紧凑编辑型首屏、可靠双栏、资源与执行卡重排、轻量 GSAP 反馈 | [实验版 HTML](../app/pokemmo-breeding-planner-v1.1.0-2026-08-24.html) |

## 如何选择版本

- 想直接使用规划器：使用当前的 [`v1.0.9`](../app/pokemmo-breeding-planner-v1.0.9-2026-08-24.html)。
- 想体验独立的新 UI：打开 [`v1.1.0`](../app/pokemmo-breeding-planner-v1.1.0-2026-08-24.html)，它不会覆盖 `v1.0.9` 的本地账本。
