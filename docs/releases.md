...
| `v1.0.7` | 2026-08-24 | 批量库存录入失效状态、活跃捐赠蛋组、真实中间物种与百变怪后备规则 | [当前 HTML](../app/pokemmo-breeding-planner-v1.0.7-2026-08-24.html) |

## 如何选择版本

- 想直接使用规划器：使用当前的 [`v1.0.7`](../app/pokemmo-breeding-planner-v1.0.7-2026-08-24.html)。
