...
| `v1.0.8` | 2026-08-24 | 精简资源标签，以真实宝可梦配装呈现顺序执行步骤，并约束待购来源分配 | [当前 HTML](../app/pokemmo-breeding-planner-v1.0.8-2026-08-24.html) |

## 如何选择版本

- 想直接使用规划器：使用当前的 [`v1.0.8`](../app/pokemmo-breeding-planner-v1.0.8-2026-08-24.html)。
