...
- 最新离线文件：[v1.0.6](app/pokemmo-breeding-planner-v1.0.6-2026-08-23.html)
...
[`v1.0.6`](app/pokemmo-breeding-planner-v1.0.6-2026-08-23.html) 是当前稳定版本。它支持：
...
- 从当前计划模型生成的 PNG 长图导出。
- 清理重复的顶层函数实现，并通过与 v1.0.5 的规划结果回归对比。
